...
export declare class Graph {
     ...
     */
    add(...items: Array<Type | Enum<any, any> | Union | Interface | Input | Query>): void;
    /**
     ...
     */
    extend(type: string | Type, definitionOrBuilder: Record<string, QueryInput> | DirectiveExtendFn): void;
    /**
